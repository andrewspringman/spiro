...
if __name__ == '__main__':
    ...
    # triple_spirograph(400, 200, 100, 97, width=1000, height=1000, points=50000, revolutions=50)
    # triple_spirograph(200, 399, 200, 99, width=1000, height=1000, points=50000, revolutions=50)
    # triple_spirograph(60, 100, 140, 59, width=1000, height=1000, points=50000, revolutions=100)
    triple_spirograph(60, 100, 140, 59, width=1000, height=1000, points=50000, revolutions=100)
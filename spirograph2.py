...
def spirograph(r1, r2, r3, width=640, height=640, padding=50, points=10000, revolutions=50):
    ...
    dwg = svgwrite.Drawing('spirograph2.svg', profile='tiny')
    ...
    for theta in angle_list:
        x = (r1 - r2) * math.cos(theta*3) + r3 * math.cos(((r1 - r2) / r3) * theta)
        y = (r1 - r2) * math.sin(theta) - r3 * math.sin(((r1 - r2) / r3) * theta/4)
